...
describe("InvestorVestingToken Scenarios", function () {
    async function deployVestingFixture() {
        ...
        const vestingToken = await ethers.deployContract("InvestorVestingToken", [owner.address, await amdToken.getAddress()]);
    ...
    it("Should not allow claiming before cliff ends", async function () {
        ...
        await vestingToken.connect(owner).createVesting(beneficiary.address);
